...
import dev.jlo.archimedes.scan.ScanResult;
import dev.jlo.archimedes.scan.ScannerWorld;
import dev.jlo.archimedes.scan.Seed;
import dev.jlo.archimedes.scan.ShipScanner;
import java.util.List;
import java.util.Set;
import org.bukkit.World;

/** Runs the bounded component scan against a Bukkit world. */
public final class BukkitScannerWorld implements dev.jlo.archimedes.ship.ComponentScanner {
