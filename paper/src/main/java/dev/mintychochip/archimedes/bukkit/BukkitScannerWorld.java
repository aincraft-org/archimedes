...
import dev.mintychochip.archimedes.scan.ScanResult;
import dev.mintychochip.archimedes.scan.ScannerWorld;
import dev.mintychochip.archimedes.scan.Seed;
import dev.mintychochip.archimedes.scan.ShipScanner;
import java.util.List;
import java.util.Set;
import org.bukkit.World;

/** Runs the bounded component scan against a Bukkit world. */
public final class BukkitScannerWorld implements dev.mintychochip.archimedes.ship.ComponentScanner {
